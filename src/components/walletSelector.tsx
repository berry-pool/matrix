              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                >
                  <div className="flex flex-row items-center">
                    <div className="mr-4">Select wallet</div>{" "}
                    {loading && <Spinner />}
                  </div>
                </Dialog.Title>
                <div className="mt-2">
                    ...
                    {window.cardano ? (
                            ...
                            <button
                              ...
                              onClick={async () => {
                                ...
                                try {
                                  ...
                                  if (walletName === "nami") {
                                    api.experimental.on("accountChange", () =>
                                      window.location.reload()
                                    );
                                    api.experimental.on("networkChange", () =>
                                      window.location.reload()
                                    );
                                  }
                                  await onConnected();
                      ...
                      <div className="w-full">
                        <div className="font-light">
                          No wallet found, get started with
                        </div>
                        <div className="w-full flex flex-wrap mt-6 space-x-9">
                          <a
                          ...
                          >
                            <EternlIcon />
                            <div className="font-semibold mt-2">eternl</div>
                          </a>
                          <a
                            className="flex flex-col items-center justify-center"
                          ...
                          >
                            <FlintIcon />
                            <div className="font-semibold mt-2">Flint</div>
                          </a>
                          <a
                            className="flex flex-col items-center justify-center"
                          ...
                          >
                            <NamiIcon />
                            <div className="font-semibold mt-2">Nami</div>
                          </a>
                        </div>
                      </div>
                    )}
